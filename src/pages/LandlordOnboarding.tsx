            ...
            {steps.map((s, i) => (
              <div key={s.title} className="flex items-center gap-2 flex-1">
                <motion.div
                  ...
                  className={`flex h-10 w-10 items-center justify-center rounded-full text-sm font-bold transition-colors ${i <= step ? "gradient-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}
                >
            ...
            <CardContent className="space-y-4">
              <AnimatePresence mode="wait" custom={direction}>
                ...
                >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {facilityOptions.map((f) => (
                          <motion.button
                            ...
                            className={`rounded-full px-3 py-1 text-sm transition-colors ${form.facilities.includes(f) ? "gradient-primary text-primary-foreground" : "bg-muted text-muted-foreground hover:bg-muted/80"}`}
                          >
                            {f}
                          </motion.button>
                        ))}
                  ...
                  {step === 2 && (
                    <>
                      <p className="text-sm text-muted-foreground mb-4">Upload photos of your property (exterior, rooms, facilities).</p>
              ...
              <div className="flex justify-between pt-4">
                ...
                <div className="ml-auto">
                  {step < 2 ? (
                    <Button onClick={goNext} disabled={!canNext()} className="gradient-primary text-primary-foreground">
