                ...
                <div className="flex flex-col items-center gap-1">
                  <button
                    ...
                    className={cn(
                      ...
                      isDone ? "border-primary bg-primary text-primary-foreground cursor-pointer" :
              ...
              <div className="space-y-5">
                ...
                <div className="rounded-lg bg-muted/50 p-4 space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium capitalize">{form.gender}</span>
                  </div>
                  {form.faculty && (
                    <div className="flex justify-between">
                  ...
                  {form.level && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{form.level}</span>
                    </div>
                  )}
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Budget</span>
                    <span className="font-medium">₦{form.budget_min.toLocaleString()} — ₦{form.budget_max.toLocaleString()}</span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{form.seeking_roommate ? "Yes" : "No"}</span>
                  </div>
                </div>
